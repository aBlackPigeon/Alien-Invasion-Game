...
class AlienInvasion:
    ...
    def _check_event(self):
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                mouse_pos = pygame.mouse.get_pos() # returns mouse click x & y coordinates
                self._check_play_button(mouse_pos) # check mouse click on button only
    ...
    def _check_play_button(self,mouse_pos):
        #start a new game when the player clicks in 
    ...
    def _check_bullet_alien_collisons(self):
        #check for collision between alien and bullet
        # get rid of aliens
        ...
        if not self.aliens:
            #destroy existing bullets and create new aliens
            self.bullets.empty()
            self._create_fleet()
    ...
    def _create_fleet(self):
        ...
        #create alien and find number of aliens which can fit in a row
        ...
        # determine number of row of aliens that fit on the screen
    ...
    def _check_fleet_edges(self):
        #respond when alien reaches any edge
